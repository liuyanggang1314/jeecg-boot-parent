 ...
 */
@Data
@ApiModel(value = "cyt_orderPage对象", description = "订单信息")
public class CytOrderPage {
    ...
    @ExcelCollection(name = "车票信息")
    @ApiModelProperty(value = "车票信息")
    private List<CytTickets> cytTicketsList;
